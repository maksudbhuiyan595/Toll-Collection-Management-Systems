...
<div class="row">
  <div class="col-md-10 offset-md-1">
    <div class="card m-3 p-3">
      <div class="card-body">
        <h2 class="text-center"><strong>Create booths report</strong></h2>
        <hr class="mb-3">
          ...
          <form action="{{route('booth.report.search')}}" method="get">
  ...
  <tbody>
    @if(isset($boothReports))
    @foreach($boothReports as $value)
...
<div class="d-grid gap-2">
    <button onclick="printDiv('boothReport')" class="btn btn-outline-info">Print</button>
